...
$headers = json_decode(file_get_contents(API_URL . "/api/header/map/?build=" . $build), true)['headers'];
$mapjson = json_decode(file_get_contents(API_URL . "/api/data/map/?build=" . $build . "&start=0&length=3000"), true);
