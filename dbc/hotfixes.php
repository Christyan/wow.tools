        ...
        "columnDefs": [
        {
            ...
            "render": function ( data, type, full, meta ) {
                if(showHotfixButtons){
                    if(full[7]){
                        return "<a href='/dbc/hotfix_log.php#" + full[0] + "'>" + full[0] + " <i class='fa fa-info-circle'></i></a> <span class='badge bg-warning'><a onclick='loadLogForm(" + full[0] + ")' data-toggle='modal' href='' data-target='#hotfixDialogModal'>Edit</a></span>";
                    }else{
                        return full[0] +  " <span class='badge bg-success'><a onclick='loadLogForm(" + full[0] + ")' data-toggle='modal' href='' data-target='#hotfixDialogModal'>Add</a></span>";
                    }
                }else{
                    if(full[7]){
